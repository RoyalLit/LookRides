      ...
      <section className={styles.content}>
        <div className={styles.inner}>
          ...
          <div className={styles.section}>
            ...
            <p>For advance tokens or full payments, you may receive a secure payment link via SMS or WhatsApp. All online transactions are 100% securely processed by our official payment partner, <strong>PayU</strong>. We accept all major UPI apps, credit cards, debit cards, and netbanking.</p>
          </div>
