...
const inCarAmenities = [
  ...
  },
  {
    ...
    desc: "Enjoy music and video controls on the dashboard touchscreen display or pair via Bluetooth audio sync to stream your favorite playlists.",
    image: "/amenities/Entertainment.png",
    badge: "HD Display",
    Icon: Tv,
    tagLine: "In-Dash Display • Bluetooth Audio Sync",
  },
  {
