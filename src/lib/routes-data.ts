...
export const allRoutes: RouteData[] = [
  ...
  },
  {
    ...
    metaDesc: 'Book Mohali to Amritsar taxi from ₹3,499. Visit the Golden Temple with comfort. Sedan & Innova. Fixed pricing, professional drivers.',
    keywords: ['mohali to amritsar taxi', 'amritsar cab from mohali', 'golden temple taxi', 'mohali amritsar car rental'],
    highlights: [
      'Route via Kharar & Ropar',
      'Comfortable AC journey',
      'Toll & fuel included',
    ],
    stops: ['Kharar', 'Ropar', 'Nawanshahr', 'Phagwara', 'Jalandhar', 'Amritsar'],
    via: 'Jalandhar',
    description: 'Travel from Mohali to Amritsar safely and comfortably. Ideal route to visit the Golden Temple without delays.',
    faqs: [
      { q: 'What is the Mohali to Amritsar taxi fare?', a: 'The one-way fare is ₹3,499 for a sedan and ₹5,499 for an Innova Crysta.' },
      { q: 'Which route do you take to Amritsar from Mohali?', a: 'We start via Kharar and join the NH344A at Ropar towards Jalandhar and Amritsar.' },
    ],
  },
  {
