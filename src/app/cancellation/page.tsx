        ...
        <div className={styles.inner}>
          ...
          <div className={styles.section}>
            ...
            <ul>
              ...
              <li>The amount is automatically routed back to your original payment method (UPI, credit/debit card, or netbanking) through our secure <strong>PayU</strong> gateway.</li>
