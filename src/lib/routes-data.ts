...
export const allRoutes: RouteData[] = [
  {
    ...
    category: 'outstation',
    metaTitle: 'Chandigarh to Delhi Taxi @ ₹3,999 | Outstation Cab Service | LookRides',
    metaDesc: 'Book Chandigarh to Delhi taxi from ₹3,999. Premium outstation cab service via NH44. Sedan & Innova Crysta. Fixed pricing, all tolls & taxes included. Door-to-door, 24/7 availability.',
    keywords: ['chandigarh to delhi taxi', 'chandigarh delhi cab', 'delhi airport taxi from chandigarh', 'outstation taxi chandigarh delhi', 'cab from chandigarh to delhi', 'chandigarh to delhi taxi fare'],
    highlights: [
  ...
  },
  {
    ...
    category: 'outstation',
    metaTitle: 'Chandigarh to Manali Taxi @ ₹5,499 | Hill Station Cab Service | LookRides',
    metaDesc: 'Book Chandigarh to Manali taxi from ₹5,499. Scenic 7-hr mountain journey via Kullu with experienced hill drivers. Sedan & Innova Crysta. Fixed pricing, all tolls included.',
    keywords: ['chandigarh to manali taxi', 'manali cab from chandigarh', 'chandigarh manali car rental', 'hill station cab', 'kullu manali taxi', 'chandigarh to manali taxi fare', 'cab to manali'],
    highlights: [
  ...
  },
  {
    ...
    category: 'outstation',
    metaTitle: 'Chandigarh to Shimla Taxi @ ₹2,799 | Hill Station Cab Service | LookRides',
    metaDesc: 'Book Chandigarh to Shimla taxi from ₹2,799. Quick 3-hr scenic hill journey via NH5. Sedan & Innova Crysta. Fixed pricing, all tolls included. 24/7 booking.',
    keywords: ['chandigarh to shimla taxi', 'shimla cab from chandigarh', 'chandigarh shimla car rental', 'shimla hill station taxi', 'chandigarh to shimla taxi fare', 'cab to shimla'],
    highlights: [
  ...
  },
  {
    ...
    category: 'airport',
    metaTitle: 'Chandigarh to Delhi Airport Taxi @ ₹4,299 | IGI Airport Cab | LookRides',
    metaDesc: 'Book Chandigarh to Delhi IGI Airport taxi from ₹4,299. Direct drop to T1/T3 terminals. Flight tracking, luggage assistance. Sedan & Innova Crysta. 24/7 airport transfers.',
    keywords: ['chandigarh to delhi airport taxi', 'chandigarh to igi airport cab', 'delhi airport pickup chandigarh', 'ixc to del airport taxi', 'chandigarh to delhi airport fare'],
    highlights: [
  ...
  },
  {
    ...
    metaDesc: 'Book Chandigarh to Amritsar taxi from ₹3,499. Visit Golden Temple & Wagah Border. 4-hr drive via NH344A. Sedan & Innova Crysta. Fixed pricing, professional drivers.',
    keywords: ['chandigarh to amritsar taxi', 'amritsar cab from chandigarh', 'golden temple taxi', 'chandigarh amritsar car rental', 'chandigarh to amritsar taxi fare'],
    highlights: [
  ...
  {
    slug: 'mohali-to-amritsar',
    from: 'Mohali', to: 'Amritsar',
    fromCity: 'Mohali', toCity: 'Amritsar',
    distance: '225 km', duration: '4 - 4.5 hours',
    sedanPrice: '₹3,499', suvPrice: '₹5,499',
    category: 'outstation',
    metaTitle: 'Mohali to Amritsar Taxi @ ₹3,499 | Golden Temple Cab | LookRides',
    metaDesc: 'Book Mohali to Amritsar taxi from ₹3,499. Direct one-way taxi to Golden Temple and Wagah Border. Professional highway drivers, sanitized sedan & SUV options.',
    keywords: ['mohali to amritsar taxi', 'amritsar cab from mohali', 'golden temple taxi from mohali', 'mohali amritsar car rental'],
    highlights: [
      'Doorstep pickup from Mohali sectors',
      'Fast bypass route via Kharar Flyover',
      'Experienced dual-lane highway drivers',
      'All toll plaza charges & GST included',
      'Flexible breaks at top Jalandhar dhabas',
    ],
    stops: ['Kharar', 'Ropar', 'Nawanshahr', 'Phagwara', 'Jalandhar', 'Amritsar'],
    via: 'Jalandhar',
    description: 'Enjoy a hassle-free and comfortable road trip from Mohali to Amritsar. Our route takes you via the newly constructed Kharar Flyover to bypass city bottlenecks, joining the NH344A highway at Ropar. We offer direct door-to-door drops to the Golden Temple (Harmandir Sahib), Wagah Border, and local hotels. Ideal for families and tourists looking for professional service without hidden charges.',
    faqs: [
      { q: 'What is the Mohali to Amritsar taxi fare?', a: 'The one-way taxi fare starts at ₹3,499 for an AC sedan (Dzire/Etios) and ₹5,499 for a premium SUV (Innova Crysta). Fares are fully inclusive of all highway tolls, state entry taxes, fuel, and driver allowances.' },
      { q: 'Which route do you take to Amritsar from Mohali?', a: 'We start from Mohali sectors, cross the Kharar Flyover, head towards Ropar, and then take the NH344A through Nawanshahr, Phagwara, and Jalandhar, before merging onto NH3 to Amritsar. This route avoids the heavy industrial traffic of Ludhiana.' },
      { q: 'Can we stop for food along the way?', a: 'Yes! Our drivers are highly familiar with the route and can recommend the best clean family-friendly dhabas and food plazas near Nawanshahr or Jalandhar for quick refreshments.' },
    ],
  },
  {
  ...
  },
  {
    ...
    highlights: [
      'On-time guaranteed airport pickup',
      'Real-time flight status tracking',
      'Assistance with heavy luggage',
      'Fixed pricing with no peak surcharge',
    ],
    stops: ['Sector 70', 'Airport Road', 'Chandigarh Airport'],
    description: 'Get a reliable and fast airport transfer from any sector in Mohali directly to Chandigarh International Airport (IXC). We navigate via the wide Airport Road to ensure a smooth, traffic-free ride of just 20 to 30 minutes. Perfect for corporate flyers and vacationers who require timely, stress-free pickups and drops at any time of the day or night.',
    faqs: [
      { q: 'How much is a cab from Mohali to Chandigarh Airport?', a: 'Our fixed fare starts at ₹599 for a sedan (Dzire/Etios) and ₹899 for a premium SUV (Innova Crysta). The price is all-inclusive with no hidden waiting charges.' },
      { q: 'Which areas of Mohali do you cover?', a: 'We cover all sectors and phases of Mohali, including Sector 70, 71, 78, Phase 3B2, Phase 7, Aerocity, and IT Park. Our driver will pick you up directly from your doorstep.' },
      { q: 'What happens if my flight is delayed?', a: 'We monitor your flight status in real-time. If your incoming flight to Chandigarh is delayed, your driver will adjust the pickup time accordingly at no extra cost.' },
    ],
  },
  {
  ...
  },
  {
    ...
    highlights: [
      'Shortest route via Airport Road bypass',
      '24/7 dispatcher and driver dispatch',
      'Clean, fully air-conditioned vehicles',
      'Flight delay tracking included',
    ],
    stops: ['Sector 5', 'Airport Road', 'Chandigarh Airport'],
    description: 'Experience the quickest and most comfortable way to reach Chandigarh International Airport (IXC) from Panchkula. We utilize the optimized traffic-free bypass paths to complete the 12 km journey in under 25 minutes. Ideal for early morning and late night flights, offering complete safety and professional chauffeurs.',
    faqs: [
      { q: 'How much is a cab from Panchkula to Chandigarh Airport?', a: 'The flat fare is ₹499 for a sedan and ₹799 for an SUV. Fares are fully transparent and fixed before you book.' },
      { q: 'How long does it take from Panchkula to Chandigarh Airport?', a: 'It typically takes only 15 to 25 minutes from most sectors in Panchkula, as the airport is conveniently located just 12 km away via the connecting Airport Road.' },
      { q: 'Do you serve all sectors of Panchkula?', a: 'Yes! We serve all residential sectors of Panchkula (Sectors 1 to 28), MDC (Mansa Devi Complex), and Pinjore/Kalka outer connections.' },
    ],
  },
  {
    ...
    highlights: [
      'Direct highway pickup and fast transfer',
      'Experienced driver familiar with highway shortcuts',
      'Flight-tracking with prompt adjustments',
      'Clean, comfortable sedans and SUVs',
    ],
    stops: ['Zirakpur', 'Airport Road', 'Chandigarh Airport'],
    description: 'Book the fastest and most reliable airport transfer from Derabassi to Chandigarh Airport (IXC). Covering a distance of 25 km, our experienced drivers navigate through the Zirakpur highway or local bypasses to ensure you avoid peak traffic bottlenecks, delivering you to the departure terminal in 30 to 40 minutes.',
    faqs: [
      { q: 'What is the fare from Derabassi to Chandigarh Airport?', a: 'Our one-way fare starts at ₹799 for a sedan and ₹1,199 for a premium SUV. Tolls and taxes are fully covered in this pricing.' },
      { q: 'How long does it take from Derabassi to Chandigarh Airport?', a: 'The journey takes approximately 30 to 40 minutes depending on traffic conditions on the Ambala-Chandigarh highway.' },
      { q: 'Do you serve all residential and industrial areas in Derabassi?', a: 'Yes! We provide doorstep pickups across all of Derabassi, including College Road, Barwala Road, Nabha Sahib, and the Industrial Area.' },
    ],
  },
  {
